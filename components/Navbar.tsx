...
function Navbar() {
  ...
  return (
    <header
      className={twMerge(
        'w-[100vw] xl:px-20 xl:py-6 lg:px-8 lg:py-6 md:py-5 md:px-14 py-2 px-6 fixed top-0 z-10 flex flex-row items-center justify-between lg:border-b border-third navbar-bg',
