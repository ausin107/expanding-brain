...
function Footer({}) {
  return (
    <footer className='flex items-center justify-end w-full relative bottom-0 shadow-lg md:px-20 md:py-5 md:overflow-hidden py-5'>
