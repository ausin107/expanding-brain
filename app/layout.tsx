      ...
      <body className=''>
        ...
        <footer className='flex items-center justify-end w-full absolute bottom-0 shadow-lg px-20 py-5'>
          ...
          <div className='absolute z-10 flex items-center'>
            ...
            <div className='flex items-center mr-3'>
              <div className='w-[3px] h-2 bg-[#75835D] opacity-40 mr-1'></div>
              <div className='w-[3px] h-2 bg-[#75835D] opacity-40 mr-1'></div>
              <div className='w-[3px] h-2 bg-[#75835D] opacity-40 mr-1'></div>
              <div className='w-7 h-2 bg-[#75835D] opacity-40 mr-3'></div>
              <div className='text-secondary uppercase font-semibold text-sm'>total users / 100,000</div>
            </div>
            <div className='flex items-center mr-20'>
              <div className='w-7 h-2 bg-[#75835D] opacity-40 mr-1'></div>
              <div className='w-[3px] h-2 bg-[#75835D] opacity-40 mr-3'></div>
