      ...
      <ol className='list-decimal text-secondary xl:text-xl px-10'>
        <li className='mb-5'>
          ...
          <ul className='list-disc text-third mt-4 px-4'>
            <li className='mb-3'>
              <strong className='text-secondary'>Personal Information:</strong> When you visit connectwallet.app or use
              our services, we may collect personal information such as your name, email address, contact details, and
            ...
            <li className='mb-3'>
              <strong className='text-secondary'>Third-Party Sources:</strong> We may receive information about you from
              third-party sources to enhance our services or for marketing purposes. We ensure that such sources have
              lawful bases for disclosing your information.
            </li>
          </ul>
        </li>
        <li className='mb-5'>
        ...
        <li className='mb-5'>
          ...
          <ul className='list-disc text-third mt-4 px-4'>
            ...
            <li>
              We may also disclose your information in response to legal requests or to protect our rights, property, or
              safety.
            </li>
          </ul>
        </li>
        <li className='mb-5'>
          ...
          <ul className='list-disc text-third mt-4 px-4'>
            <li>
              We use cookies and similar tracking technologies to enhance your experience on connectwallet.app, analyze
              usage patterns, and personalize content. You can manage your cookie preferences through your browser
              settings.
            </li>
          </ul>
        </li>
        ...
        <li className='mb-5'>
          ...
          <ul className='list-disc text-third mt-4 px-4'>
            <li>
              You have the right to access, correct, or delete your personal information held by connectwallet.app. You
        ...
        <li className='mb-5'>
          ...
          <ul className='list-disc text-third mt-4 px-4'>
            <li>
              ...
              provided us with personal information, please contact us, and we will take appropriate steps to remove
              such information.
            </li>
          </ul>
        </li>
