...
function Home() {
  ...
  return (
    <div className='lg:h-auto h-fit md:h-screen min-h-screen flex flex-col items-center lg:pt-32 md:pt-40 pt-24 pb-16 px-5 bg-gradient-to-b from-black to-[#121c1c]'>
